    ...
    <body class="bg-dots-darker bg-center bg-repeat dark:bg-dots-lighter">
        <div class="w-full px-4 sm:px-6 lg:px-12 xl:px-24 2xl:px-32">
            <div class="flex flex-col items-center justify-center min-h-screen w-full">
                <img src="{{ asset('images/LOGO_RENACER_LETRAS_NEGRAS_2.png') }}" alt="Logo Renacer (Claro)" class="block dark:hidden h-48 w-auto px-4 object-contain mb-8">
                <img src="{{ asset('images/LOGO_RENACER_LETRAS_BLANCAS.png') }}" alt="Logo Renacer (Oscuro)" class="hidden dark:block h-48 w-auto px-4 object-contain mb-8">
                <x-primary-button x-data="" x-on:click.prevent="$dispatch('open-modal', 'login-modal')" class="bg-blue-600 hover:bg-blue-700 active:bg-blue-900 focus:ring-blue-500 text-lg px-8 py-4">
                    {{ __('Iniciar Sesión') }}
                </x-primary-button>
            </div>
        </div>
        <x-modal name="login-modal" :show="$errors->login->isNotEmpty()" focusable>
            <form method="POST" action="{{ route('login') }}" class="p-6">
                ...
                <div class="flex justify-center mb-4">
                    <img src="{{ asset('images/LOGO_RENACER_LETRAS_NEGRAS_2.png') }}" alt="Logo Renacer" class="h-20 w-auto object-contain">
                </div>
