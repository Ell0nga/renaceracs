<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" x-cloak>
        <div class="w-full max-w-none px-4 sm:px-6 lg:px-12 xl:px-24 2xl:px-32 mx-auto">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                        ...
                        <!-- Nuevo enlace para Reportes de Fibra -->
                        <x-nav-link :href="route('fiber.reports.index')" :active="request()->routeIs('fiber.reports.index')">
                            {{ __('Reportes de Fibra') }}
                        </x-nav-link>
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <!-- Nuevo enlace para Reportes de Fibra en menú móvil -->
                <x-responsive-nav-link :href="route('fiber.reports.index')" :active="request()->routeIs('fiber.reports.index')">
                    {{ __('Reportes de Fibra') }}
                </x-responsive-nav-link>

                <!-- Enlaces de Finanzas en menú móvil -->
