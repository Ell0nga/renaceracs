    ...
    <div class="container mt-5">
        ...
        <form id="fiberForm" class="mt-4">
            ...
            <div class="mb-3">
                ...
                <div class="d-flex">
                    <div class="me-3">
                        <img src="https://via.placeholder.com/100?text=SC/APC" alt="SC/APC" class="connector-image" data-type="SC/APC">
                        <p class="text-center">SC/APC</p>
                    </div>
                    <div>
                        <img src="https://via.placeholder.com/100?text=SC/UPC" alt="SC/UPC" class="connector-image" data-type="SC/UPC">
